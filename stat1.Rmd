...
+Deep learning models were utilized to address the limitations of machine learning models. +The basic deep learning model consisted of a 3-layer binary deep neural network with 20 nodes in each hidden layer.
    
+The Relu function was used as the activation function in the hidden
layers, while the sigmoid function was employed in the output layer.
    
+Binary cross-entropy was used as the loss function, and stochastic gradient descent was employed as the optimizer for the model. <br>
