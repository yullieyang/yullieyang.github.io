...
### 3. Methodology & Summary
    ...
    +Deep learning models were utilized to address the limitations of
    machine learning models. +The basic deep learning model consisted of a
    3-layer binary deep neural network with 20 nodes in each hidden layer.
    ...
    +Binary cross-entropy was used as the loss function, and stochastic
    gradient descent was employed as the optimizer for the model. <br>
